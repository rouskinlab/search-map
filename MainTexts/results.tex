...
\begin{figure}[H]
	...
	\caption{\textbf{Refinement of the long-range interaction and competition with the frameshift pseudoknot.} \textbf{(a)} Refined model of the long-range interaction (predicted from cluster 1 in Figure \ref{tiles}c and d) featuring alternative stem 1 (AS1)~\cite{Lan2022}; the attenuator hairpin (AH)~\cite{Su2005}; and long stems LS1, LS2a/b, LS3a/b, and LS4. The location of pseudoknot stems PS1, PS2, and PS3 is also indicated; as are the base pairs they overlap in AS1 and LS2b.}
	\label{lnas}
\end{figure}

To verify the newly predicted long stems, we performed SEARCH-MaP on the 1,799 nt segment using 15-20 nt LNA/DNA mixmer ASOs to reach single-stem precision (Figure \ref{lnas}b).
